...
import {RootState, updateGroupSubScreenMode, updateGroupSubScreenWidthSize} from "../../../../../entities/redux";
import {
    ScrollMarginInline,
    ScrollMin_width
} from "../../../../../features/messsage/messageScrollBox/ui/MessageScrollBoxStyled";
import {GroupUserList_Container_width} from "../../../../../features/group/members";


export const useScreenMode = (param:string, contentSize:{width:number,height:number}, showUserList:boolean):boolean =>{
