...
export const DateEventTag : React.FC = () =>{
    ...
    const createNewTag = ()=>{
        ...
        dispatch(createDateEventTag({tagId: Date.now().toString() ,name:newTagName, color:newTagColor, defaultTag:false}));
            ...
            <AddTagButton_Container>
                {createTag ?
                    <CreateButton_Container>
                        <Modal_Condition_Button style={{width:'calc(50% - 10px)', height:"30px", marginLeft:'6px'}}
