...
export const CreateGroupEvent: React.FC<{ onClose: () => void }> = ({onClose}) => {
    ...
    const createGroupSchedule = () => {
        ...
        createGroupScheduleApi(param, groupScheduleTitle, startDate, privacy, isLimit ? maxPeople : 0)
    }
            ...
            <CreateGroupEvent_Container>
                ...
                <CreateGroupEvent_Wrapper>
                    <GroupEvent_RowBox>
                        ...
                        <GroupEventTitle_Input value={groupScheduleTitle} onChange={(e) => dispatchGroupEvent({
                            type: 'SET_TITLE',
                    ...
                    <GroupEvent_RowBox style={{justifyContent: 'right'}}>
                        ...
                        <Modal_Condition_Button $isAble={groupScheduleTitle !== ''}
                                                style={{height: "100%", width: '50px'}} onClick={createGroupSchedule}>
                            생성
                        </Modal_Condition_Button>
                    </GroupEvent_RowBox>
                </CreateGroupEvent_Wrapper>
