...
// import {debounce, throttleByAnimationFrame} from "../../../../src/shared/lib";
// import {endPointMap, scrollPointMap} from "../../../../src/entities/redux";
// import {requestFile} from "../../../../src/entities/redux";
...
//             dispatch(requestFile({ target: 'groupMsg', param: param, requestFile: "ENDPOINT" }));
