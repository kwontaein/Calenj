...
public class GroupController {
    ...
    public void makeGroup(@RequestBody GroupDTO.Request groupDTO) {
    ...
    public GroupDetailDTO.Response groupDetail(@RequestBody GroupDetailDTO.Request request) {
    ...
    public String joinGroup(@RequestBody GroupDetailDTO.Request request) {
    ...
    public String inviteCode(@RequestBody InviteCodeDTO.Request inviteCodeDTO) { //그룹 초대
        //링크 테이블에 저장
    ...
    public InviteCodeDTO.Response inviteGroup(@RequestBody InviteCodeDTO.Request inviteCodeDTO) {
