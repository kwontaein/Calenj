...
public interface GroupRepository extends JpaRepository<GroupEntity, UUID> {
    ...
    @Query("select new org.example.calenj.Main.DTO.Group.GroupResponse(g.groupId, g.groupTitle) from Group_table g JOIN Group_User gu ON g.groupId = gu.group.groupId where gu.user.userEmail = :userEmail")
    ...
    @Query("SELECT new org.example.calenj.Main.DTO.Group.GroupResponse(g.groupId, g.groupTitle, g.groupCreated ,g.groupCreater) FROM Group_table g WHERE g.groupId = :groupId")
