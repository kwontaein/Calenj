...
public class GroupVoteDTO {
    ...
    public static class Response {
        ...
        private List<String> countVoter;
        private List<String> postedVoteChoiceDTO; //처음 투표 생성 시 항목을 받아오기 위한 필드
        private List<VoteChoiceDTO.Response> voteChoiceDTO;
        private boolean[] myVote;


        public Response(String voteCreater, String voteTitle, String voteCreated, String voteEndDate, Boolean isMultiple, Boolean anonymous, List<String> voteWatcher, List<String> countVoter) {
        ...
        //list만 불러오기위한 생성자
        public Response(UUID voteId, String voteCreater, String voteTitle, String voteCreated, String voteEndDate, List<String> countVoter) {
            this.voteId = voteId;
            this.voteCreater = voteCreater;
            this.voteTitle = voteTitle;
            this.voteCreated = voteCreated;
