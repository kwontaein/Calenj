...
public interface InviteCodeRepository extends JpaRepository<InviteCodeEntity, String> {
    ...
    @Query("SELECT new org.example.calenj.Main.DTO.Group.InviteCodeDTO.Response(ic.group.groupId,ic.group.groupTitle,ic.user.nickname,ic.endDateTime,ic.useAbleCount,ic.maxUseAble) FROM InviteCode ic WHERE ic.inviteCode = :inviteCode GROUP BY ic.group.groupTitle, ic.user.nickname, ic.endDateTime")
    Optional<InviteCodeDTO.Response> findByInviteCode(@Param("inviteCode") String inviteCode);
    ...
    Optional<InviteCodeDTO.Response> findByGroupId(@Param("groupId") UUID groupId);
