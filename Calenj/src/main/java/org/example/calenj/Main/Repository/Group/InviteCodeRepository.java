...
public interface InviteCodeRepository extends JpaRepository<InviteCodeEntity, String> {
    ...
    @Query("SELECT new org.example.calenj.Main.DTO.Response.Group.InviteCodeResponse(ic.group.groupId,ic.group.groupTitle,ic.user.nickname,ic.endDateTime,ic.useAbleCount,ic.maxUseAble) FROM InviteCode ic WHERE ic.inviteCode = :inviteCode GROUP BY ic.group.groupTitle, ic.user.nickname, ic.endDateTime")
    Optional<InviteCodeResponse> findByInviteCode(@Param("inviteCode") String inviteCode);

    @Query("SELECT new org.example.calenj.Main.DTO.Response.Group.InviteCodeResponse(ic.user.nickname,ic.inviteCode,ic.endDateTime,ic.useAbleCount) FROM InviteCode ic WHERE ic.group.groupId = :groupId ")
