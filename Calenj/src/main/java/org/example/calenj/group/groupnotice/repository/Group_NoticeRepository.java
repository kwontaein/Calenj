...
public interface Group_NoticeRepository extends JpaRepository<GroupNoticeEntity, GroupNoticeId> {
    ...
    @Query("SELECT new org.example.calenj.group.groupnotice.dto.response.GroupNoticeResponse(gn.noticeId,gn.noticeTitle, gn.noticeContent, gn.noticeCreator, gn.noticeCreated) FROM Group_Notice gn WHERE gn.group.groupId = :groupId")
    ...
    @Query("SELECT new org.example.calenj.group.groupnotice.dto.response.GroupNoticeResponse(gn.noticeId,gn.noticeTitle, gn.noticeContent, gn.noticeCreator, gn.noticeCreated, gn.noticeWatcher) FROM Group_Notice gn WHERE gn.noticeId = :noticeId")
